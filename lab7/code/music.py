...
music_folder = "/Users/User/Desktop/PP2/LABs/lab7/musics"
...
background = pygame.image.load(os.path.join("signs", "background.png"))
...
playb = pygame.image.load(os.path.join("signs", "play.png"))
pausb = pygame.image.load(os.path.join("signs", "pause.png"))
nextb = pygame.image.load(os.path.join("signs", "next.png"))
prevb = pygame.image.load(os.path.join("signs", "back.png"))
