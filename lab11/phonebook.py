...
conn = psycopg2.connect(host="localhost", dbname="postgres", user="postgres",
                        password="232326.Asiko", port=5432)
...
while True:
    ...
    1. Type "i" in order to INSERT data to the table.
    2. Type "u" in order to UPDATE data in the table.
    3. Type "q" in order to make specific QUERY in the table.
    4. Type "d" in order to DELETE data from the table.
    5. Type "s" in order to see the values in the table.
    6. Type "f" in order to close the program.
    """)
